...
private:
  ...
  const float magn_ellipsoid_center[3] = {193.839, 251.685, -136.507};
  const float magn_ellipsoid_transform[3][3] = {{0.863822, -0.0395882, 0.0301540},
                                               {-0.0395882, 0.697368, 0.0196020}, 
                                               {0.0301540, 0.0196020, 0.992920}};
  // Sensor variables
